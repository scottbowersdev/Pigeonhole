            ...
            <form class="max-w-screen-md m-auto" method="POST" action="/wishlist">
                ...
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-12">
                        <h2 class="text-base/7 font-semibold text-gray-900 dark:text-white">Add new wishlist item</h2>
                        <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-100">Please add your new information below.</p>
