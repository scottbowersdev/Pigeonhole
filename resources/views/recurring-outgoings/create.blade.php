    ...
    <form class="max-w-screen-md m-auto" method="POST" action="/recurring-outgoings/new">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <h2 class="text-base/7 font-semibold text-gray-900">Add new recurring outgoing</h2>
                <p class="mt-1 text-sm/6 text-gray-600">Please add your new recurring outgoing below.</p>
                        ...
                        <div class="sm:col-span-5">
                            ...
                            <div class="mt-2">
                                <div class="flex items-center rounded-md bg-white pl-3 outline outline-1 -outline-offset-1 {{ $errors->has('day') ? 'outline-red-500' : 'outline-gray-300' }} focus-within:outline focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                                    <input type="number" name="day" id="day" class="block min-w-0 grow py-1.5 pl-1 px-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6" placeholder="5">
                                </div>
                                @error('day')
